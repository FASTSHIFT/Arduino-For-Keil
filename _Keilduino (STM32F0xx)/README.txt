...
//Upgrade   2019.12.25 V_2.3 SPI库可以正常使用，添加使用内部时钟选项，同步_Keilduino(STM32F10x) V_7.5部分代码
//Upgrade   2020.1.15  V_2.4 由于Print库的printf不支持浮点输出，将Print库还原，使用vsnprintf转换printf 