...
#define SD_CHIP_SELECT_PIN PB12
//#else
//int  SD_CHIP_SELECT_PIN = SDCARD_SS_PIN;
#endif
...
//#else
//int SPI_MOSI_PIN = SDCARD_MOSI_PIN;
//int SPI_MISO_PIN = SDCARD_MISO_PIN;
//int SPI_SCK_PIN = SDCARD_SCK_PIN;
#endif
...
class Sd2Card {
 public:
  ...
  uint8_t init(uint8_t sckRateID, int chipSelectPin);
