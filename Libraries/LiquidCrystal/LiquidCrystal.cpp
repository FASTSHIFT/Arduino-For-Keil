...
LiquidCrystal::LiquidCrystal(int rs, int rw, int enable,
...
LiquidCrystal::LiquidCrystal(int rs, int enable,
                             int d0, int d1, int d2, int d3,
                             int d4, int d5, int d6, int d7)
{
...
void LiquidCrystal::init(uint8 fourbitmode, int rs, int rw, int enable,
                         int d0, int d1, int d2, int d3,
                         int d4, int d5, int d6, int d7)
{
  _rs_pin = rs;
...
void LiquidCrystal::pulseEnable(void) {
  ...
  GPIO_ToggleBits((GPIO_TypeDef*)(_enable_pin&~0x0F),1<<(_enable_pin&0x0F));// togglePin(_enable_pin);
  delayMicroseconds(1);
  GPIO_ToggleBits((GPIO_TypeDef*)(_enable_pin&~0x0F),1<<(_enable_pin&0x0F));// togglePin(_enable_pin);
