...
void SPIClass::begin(void) 
{
	...
	if(SPIx == SPI1)
	{
		...
		GPIO_PinAFConfig(GPIOA, Get_GPIO_PinSource(GPIO_Pin_5), GPIO_AF_SPI1);
		GPIO_PinAFConfig(GPIOA, Get_GPIO_PinSource(GPIO_Pin_6), GPIO_AF_SPI1);
		GPIO_PinAFConfig(GPIOA, Get_GPIO_PinSource(GPIO_Pin_7), GPIO_AF_SPI1);
	...
	else if(SPIx == SPI2)
	{
		...
		GPIO_PinAFConfig(GPIOB, Get_GPIO_PinSource(GPIO_Pin_13), GPIO_AF_SPI2);
		GPIO_PinAFConfig(GPIOB, Get_GPIO_PinSource(GPIO_Pin_14), GPIO_AF_SPI2);
		GPIO_PinAFConfig(GPIOB, Get_GPIO_PinSource(GPIO_Pin_15), GPIO_AF_SPI2);
